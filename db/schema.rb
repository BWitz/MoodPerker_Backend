...
ActiveRecord::Schema.define(version: 2019_02_11_170220) do
  ...
  create_table "contentnews", force: :cascade do |t|
    t.string "news_src"
    t.string "title"
    t.string "description"
    t.datetime "created_at", null: false
  ...
  create_table "happyimgs", force: :cascade do |t|
    t.string "img_url"
    t.integer "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "happynews", force: :cascade do |t|
    t.string "news_src"
    t.string "title"
    t.string "description"
    t.datetime "created_at", null: false
  ...
  create_table "sadnews", force: :cascade do |t|
    t.string "news_src"
    t.string "title"
    t.string "description"
    t.datetime "created_at", null: false
